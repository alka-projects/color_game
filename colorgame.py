...
score=0
timeleft=60
answers=["blue","white","yellow","green","pink","red","purple","violet","orange","brown",]
words=["white","blue","red","orange","purple","violet","pink","brown","yellow","green",]
word=random.randrange(0,10,1)
def start():
   global answers,words,word
   l3.config(text=words[word],fg=answers[word])
   countdown()
def check():
...
l1=Label(root,text="write the correct colour of the word....",font=("Girassol",18),bg="black",fg="white")
l1.pack()
...
b3=Button(root,text="change",font=("Baloo Bhai",13),bg="pink",width=18,command=reset)
b2.pack(pady=20)
b3.pack()
